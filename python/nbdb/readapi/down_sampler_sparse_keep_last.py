...
class DownSamplerSparseKeepLast(DownSamplerSparseBase):
    """
    keep last aggregator for sparse time series
    """
    ...
    def process_sparse_data(self, delta_epoch: int, value: float) -> None:
        ...
        if self.trace:
            logger.info('[Trace: %s] '
                        'DownSamplerSparseKeepLast.process_sparse_data: '
    ...
    def complete_sparse_data(self) -> None:
        ...
        :return:
        """
        # nothing to do for keep last
        if self.trace:
            logger.info('[Trace: %s] '
                        'DownSamplerSparseKeepLast.complete_sparse_data: '
